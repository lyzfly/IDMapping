...
public class UserCountReducer extends TableReducer<Text,fact_idBean,ImmutableBytesWritable> {
    ...
    protected void reduce(Text key, Iterable<fact_idBean> values, Context context) throws IOException, InterruptedException {
        ...
        put.addColumn("res".getBytes(), "the amount of User".getBytes(), String.valueOf(count).getBytes());
